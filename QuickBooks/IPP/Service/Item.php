 ...
 * @author Minh Ho <minh.ho@namlongsoft.net>
 *
 * @package QuickBooks
 * @subpackage IPP
 */
...
class QuickBooks_IPP_Service_Item extends QuickBooks_IPP_Service
{
    ...
    public function findByEntityId($Context, $realmID, $EntityId = null)
    {
        if ($EntityId) {
            $query ="SELECT * FROM Item WHERE Id='{$EntityId}'";
    ...
    public function findByEntityName($Context, $realmID, $name = null)
    {
        if ($name) {
