...
class QuickBooks_IPP
{
	...
	public function __construct($dsn = null, $encryption_key = null, $config = array(), $log_level = QUICKBOOKS_LOG_NORMAL, $sandbox=false)
	{
	...
	*/
	...
	{
		return $this->_sandbox= (bool) $sandbox;;
	}
